...
새 프로젝트가 생기면 "## 🚀 Projects" 표에 한 줄씩 추가하면 됩니다.
-->

<div align="center">

# 안녕하세요, 김건홍입니다 👋
**하드웨어 × 임베디드 × 실시간 제어**를 다루는 엔지니어입니다.
...
- 🔧 하드웨어 설계부터 임베디드 실시간 제어, ROS 2 기반 소프트웨어까지 폭넓게 다룹니다.
- 🧠 센서 데이터를 실제 액추에이터 명령까지 안전하게 연결하는 **제어 로직 · 안전 게이팅** 설계에 관심이 많습니다.
- 📌 진행한 프로젝트들은 아래 목록에서 확인하실 수 있습니다.
...
| 프로젝트 | 기간 | 소개 | 담당 |
|---|---|---|---|
| [1/10 자율주행 레이스카](https://github.com/GeonHoong/1_10-autonomous-race) | _2026.01 – 2026.03_ | ROS 2 기반 차선 인식·LiDAR 인지·Pure Pursuit 제어 통합 자율주행 | 하드웨어 설계, MUX 통합 제어, micro-ROS 모터 제어, LiDAR Lookahead/ROI 가변 제어 |
